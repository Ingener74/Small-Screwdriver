...
class Ui_ScreamingMercury(object):
    def setupUi(self, ScreamingMercury):
        ...
        self.imagesGroupBox = QtGui.QGroupBox(self.splitter)
        self.imagesGroupBox.setObjectName("imagesGroupBox")
        self.verticalLayout = QtGui.QVBoxLayout(self.imagesGroupBox)
        self.verticalLayout.setObjectName("verticalLayout")
        self.imageList = QtGui.QListWidget(self.imagesGroupBox)
        ...
        self.outputFormatGroupBox = QtGui.QGroupBox(self.layoutWidget)
        self.outputFormatGroupBox.setObjectName("outputFormatGroupBox")
        self.verticalLayout_11 = QtGui.QVBoxLayout(self.outputFormatGroupBox)
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.outputFormatComboBox = QtGui.QComboBox(self.outputFormatGroupBox)
        self.outputFormatComboBox.setObjectName("outputFormatComboBox")
        self.outputFormatComboBox.addItem("")
        self.outputFormatComboBox.addItem("")
        self.verticalLayout_11.addWidget(self.outputFormatComboBox)
        self.verticalLayout_3.addWidget(self.outputFormatGroupBox)
        self.atlasSizeGroupBox = QtGui.QGroupBox(self.layoutWidget)
        self.atlasSizeGroupBox.setObjectName("atlasSizeGroupBox")
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.atlasSizeGroupBox)
        ...
        self.verticalLayout_3.addWidget(self.atlasSizeGroupBox)
        ...
        self.buttonsHorizontalLayout.addWidget(self.settingsPushButton)
    ...
    def retranslateUi(self, ScreamingMercury):
        ...
        self.outputFormatComboBox.setItemText(0, QtGui.QApplication.translate("ScreamingMercury", "Jupiter", None, QtGui.QApplication.UnicodeUTF8))
        self.outputFormatComboBox.setItemText(1, QtGui.QApplication.translate("ScreamingMercury", "Cocos2D-x plist", None, QtGui.QApplication.UnicodeUTF8))
        self.atlasSizeGroupBox.setTitle(QtGui.QApplication.translate("ScreamingMercury", "Максимальный размер атласов", None, QtGui.QApplication.UnicodeUTF8))
